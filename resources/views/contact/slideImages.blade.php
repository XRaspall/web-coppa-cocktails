                ...
                <div class="swiper-container">
                    <div class="swiper-wrapper height-slideImage-carrusel">
                        ...
                        <div class="swiper-slide p-0 bg-transparent">
                            ...
                            <img class="" src="{{ asset('img/contact/carrusel/Tequila_ Sunrise_Coppa_Cocktails_8.webp') }}" alt="Image 1">
                            <img class="" src="{{ asset('img/contact/carrusel/SOTB_Coppa_Cocktails_12.webp') }}" alt="Image 3">
                            <img class="" src="{{ asset('img/contact/carrusel/Mojito_Coppa_Cocktails_5.webp') }}" alt="Image 6">
                        </div>
                        <div class="swiper-slide p-0 bg-transparent">
                            <img class="full-width" src="{{ asset('img/contact/carrusel/Whiskey Sour_Coppa_Cocktails_15.webp') }}" alt="Image 10">
                        </div>

                        <div class="swiper-slide p-0 bg-transparent">
                            <img class="" src="{{ asset('img/contact/carrusel/Strawberry_Daiquiri_Coppa_Cocktails_18.webp') }}" alt="Image 7">
                            <img class="" src="{{ asset('img/contact/carrusel/LIIT_Coppa_Cocktails_2.webp') }}" alt="Image 7">
                            <img class="" src="{{ asset('img/contact/carrusel/Negroni_Coppa_Cocktails_5.webp') }}" alt="Image 8">
                            <img class="" src="{{ asset('img/contact/carrusel/Negroni_Coppa_Cocktails_2.webp') }}" alt="Image 9">
                        </div>
                    </div>
                </div>
            </a>
