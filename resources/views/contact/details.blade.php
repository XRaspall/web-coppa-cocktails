        ...
        <div class="row w-100">
            <div class="col-12 col-md-4 d-flex align-items-center justify-content-center">
                <div class="">
                    ...
                    <h2 class="animate-on-scroll color-coppa-primary ff-BarlowCondensedSemiBold fw-bolder" data-animation="animate__fadeInUp">{{ $details['title_' . app()->getLocale()] }}</h2>
                    ...
                    <div class="animate-on-scroll d-flex justify-content-between my-3" data-animation="animate__slideInUp">
                        ...
                        <a href="{{ $details['link2'] }}"><button class="message-button ff-Montserrat">{{ $details['text2_' . app()->getLocale()] }}</button></a>
                    </div>
                </div>
            </div>
